...
export default function App() {
  ...
  // Modal state — each holds the item it's operating on (or null/false when closed)
  ...
  const [pushState, setPushState] = useState('idle'); // idle | loading | enabled | unsupported
